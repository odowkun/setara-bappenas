...
function mapDocument(d: any): AdminDocument {
  ...
  return {
    ...
    title: d.title || "Dokumen Publik",
    summary: d.summary ?? "",
    jenis: d.jenis ? String(d.jenis) : "LAINNYA",
    bidang: d.bidang ?? "",
    tahun: d.tahun ? String(d.tahun) : "2026",
    tanggalMulai: d.tanggal_mulai ?? undefined,
    tanggalSelesai: d.tanggal_selesai ?? undefined,
    ukuran: d.ukuran ?? "0 MB",
    downloads: Number(d.downloads) || 0,
    views: Number(d.views) || 0,
    uniqueViews: Number(d.unique_views) || 0,
    fileUrl: d.preview_url ? String(d.preview_url) : (d.file_url ? String(d.file_url) : ""),
